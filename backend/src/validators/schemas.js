...
const exerciseSchema = z.object({ name: z.string().min(2), category: z.string().optional(), description: z.string().optional(), videoUrl: z.string().optional(), defaultSets: z.number().optional(), defaultReps: z.number().optional() });
const exerciseAssignSchema = z.object({ patientId: z.string(), exerciseId: z.string(), sets: z.number().default(1), reps: z.number().default(10), durationMin: z.number().optional(), frequency: z.string().default('daily'), instructions: z.string().optional(), startDate: z.string().optional(), endDate: z.string().optional() });
...
const medicineAssignSchema = z.object({ patientId: z.string(), medicineId: z.string(), dosage: z.string(), scheduleTimes: z.array(z.string()).default([]), withFood: z.boolean().default(false), instructions: z.string().optional() });
